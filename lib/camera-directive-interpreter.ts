...
function build_interpreter_prompt(sample: CameraDirectivePayload): string {
  ...
  return [
    ...
    '- Always include target_agent, rationale, and reason keys; use null when not applicable.',
    '',
    'Confidence output:',
    ...
    '{ "directive": "tighten groove and add syncopation", "confidence": 0.83, "target_agent": "drums", "rationale": "right hand motion and fast steps", "reason": null }',
    '{ "directive": "ease density and keep a pocket", "confidence": 0.80, "target_agent": null, "rationale": "broad whole-body sway", "reason": null }',
    '',
